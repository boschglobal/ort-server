...
dependencies {
    ...
    implementation(projects.tasks.executorCp)
    implementation(projects.tasks.tasksSpi)
...
jib {
    ...
    to.image = "${dockerImagePrefix}ort-server-demo-task:$dockerImageTag"

    container {
        mainClass = "org.eclipse.apoapsis.ortserver.tasks.executors.cp.ClassPathExecutorKt"
