...
class AnalyzerDownloaderTest : WordSpec({
    ...
    "downloadRepository" should {
        "not recursively clone a Git repository if ignoreSubmodules is true" {
            ...
            val outputDir = downloader.downloadRepository(repositoryUrl, revision, ignoreSubmodules = true)
        ...
        "recursively clone a Git repository if ignoreSubmodules is false" {
            val repositoryUrl = "https://github.com/oss-review-toolkit/ort-test-data-git-submodules.git"
            val revision = "fcea94bab5835172e826afddb9f6427274c983b9"

            val outputDir = downloader.downloadRepository(repositoryUrl, revision, ignoreSubmodules = false)
